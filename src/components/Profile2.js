...
const Profile2 = () => {
  ...
  useEffect(() => {
    ...
    if (userData && userData.id) {
      fetchData2(userData.ownerMetaUserID);
    }
  }, [userData, baseURL3, setSubdLoading]);
  ...
  useEffect(() => {
    ...
    if (userData && userData.id) {
      fetchUserPrd(userData.ownerMetaUserID);
    }
  }, [userData, userPrdURL]);
  ...
  useEffect(() => {
    ...
    if (userData && userData.media1) {
      if (!userData.media1.includes(checkStr)) {
        tempList.push([userData.media1, userData.caption1]);
      }
      if (!userData.media2.includes(checkStr)) {
        tempList.push([userData.media2, userData.caption2]);
      }
      if (!userData.media3.includes(checkStr)) {
        tempList.push([userData.media3, userData.caption3]);
      }
      if (!userData.media4.includes(checkStr)) {
        tempList.push([userData.media4, userData.caption4]);
      }
      if (!userData.media5.includes(checkStr)) {
        tempList.push([userData.media5, userData.caption5]);
      }
      if (!userData.media6.includes(checkStr)) {
        tempList.push([userData.media6, userData.caption6]);
      }
      if (!userData.media7.includes(checkStr)) {
        tempList.push([userData.media7, userData.caption7]);
      }
      if (!userData.media8.includes(checkStr)) {
        tempList.push([userData.media8, userData.caption8]);
      }
      if (!userData.media9.includes(checkStr)) {
        tempList.push([userData.media9, userData.caption9]);
      }
      if (!userData.media10.includes(checkStr)) {
        tempList.push([userData.media10, userData.caption10]);
      }
      if (!userData.media11.includes(checkStr)) {
        tempList.push([userData.media11, userData.caption11]);
      }
      if (!userData.media12.includes(checkStr)) {
        tempList.push([userData.media12, userData.caption12]);
      }
      if (!userData.media13.includes(checkStr)) {
        tempList.push([userData.media13, userData.caption13]);
      }
      if (!userData.media14.includes(checkStr)) {
        tempList.push([userData.media14, userData.caption14]);
      }
      if (!userData.media15.includes(checkStr)) {
        tempList.push([userData.media15, userData.caption15]);
      }
      // tempList.forEach((x) => {
            ...
            <div className="relative w-full h-screen">
              ...
              >
                ...
                <div className="flex flex-col justify-center items-center">
                  <div className="flex flex-col justify-center items-center">
                    <p className="text-2xl">{userData.metausername}</p>
                    <p className="text-lg font-thin">{userData.bioCaption}</p>
              ...
              {userData.backgroundImage === CHECK_STR ? (
