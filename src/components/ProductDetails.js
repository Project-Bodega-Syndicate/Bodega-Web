...
const ProductDetails = () => {
  ...
  const { singlePrd, setSinglePrd, setUserPrfData } = useAppContext();
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex flex-row justify-between w-4/5 mt-6 pb-12">
              <button
                className="p-2 h-10 bg-neutral-800 rounded-lg text-center border-solid border-2 border-white w-36"
                onClick={openModal}
              >
                Yerrr
              </button>
