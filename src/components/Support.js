        ...
        <>
          ...
          <form className="flex flex-col w-full mt-4 pb-20">
            ...
            {/* <input
              ...
              value={userMsg}
              required
              className="p-1 mt-4 text-sm w-full h-40 rounded-md bg-neutral-800 text-white"
              placeholder=""
            /> */}
            ...
            />
            {fileDataURL ? (
              // <div className="flex flex-col mt-4 justify-center rounded-lg border-2 border-white">
              //   {
              <img
            ...
            // </div>
            null}
            <button className="p-2 mt-10 w-full h-12 bg-neutral-700 rounded-md">
              Submit
            </button>
          </form>
        </>
